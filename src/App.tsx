...
import PictorioLogoSvg from "@/images/pictorio-logo.svg";
...
export default function App() {
  ...
  return (
    <>
      ...
      <img src={PictorioLogoSvg} alt="Pictorio Logo" className="mx-auto" />
      <p className="text-md text-center tracking-tight sm:text-md">
  Search Image
</p>
